...
python -m sockeye.train -d data/nmt_genders1_prepare_data \
-vs data/genders1/newsdev2017.tc.BPE.en \
-vt data/genders1/newsdev2017.tc.BPE.lv \
--validation-source-factors data/genders1/newsdev2017.genders.BPE.en \
--encoder=transformer \
--decoder=transformer \
--num-layers=6:6 \
